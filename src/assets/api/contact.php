<?php
    ...
    if(empty($name) or empty($email) or empty($message)){
        ...
        $result = array( 'response' => 'error', 'empty'=>'name', 'message'=>'Name, email and message is required.' );
    ...
    if ( mail( $to, "[David Website]: " . $subject, $contents, $headers ) ) {
        $result = array( 'response' => 'success', 'message'=>'Message received.' );
    } else {
        $result = array( 'response' => 'error', 'message'=>'Unable to send message.  Please try again.'  );
    }
